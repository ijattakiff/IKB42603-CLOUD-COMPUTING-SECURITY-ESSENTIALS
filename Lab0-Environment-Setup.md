...
| --- | --- | --- |
| Docker | `Evidence/docker version.png` | Docker version 29.1.3 | `Evidence/docker version.png` |
| AWS CLI | `Evidence/version aws.png` | aws-cli/2.36.9 | `Evidence/version aws.png` |
| kind | `Evidence/kind version.png` | kind v0.33.0 | `Evidence/kali/3.1-kind.png` |
| kubectl | `Evidence/kubectl version.png` | Client version v1.36.3, Kustomize v5.8.0 | `Evidence/kali/3.kubectl.png` |
| OpenSSL | `Evidence/openssl and oathtool version.png` | OpenSSL 3.0.13 | `Evidence/kali/4.Helper.png` |
| oathtool | `Evidence/oathtool version.png` | OATH Toolkit 2.6.11 | `Evidence/kali/4.Helper.png` |
| LocalStack | `Evidence/localstack health.png` | Running and healthy on port 4566 | `Evidence/kali/5.localstack.png` |
| Kubernetes | `Evidence/5.1.kubenetes.png` | kind cluster `ccse` running with node `ccse-control-plane` ready | `Evidence/kali/5.1.kubenetes.png` |
| AWS CLI LocalStack endpoint | `Evidence/6.one-time.png` | Dummy credentials configured and STS caller identity tested through LocalStack | `Evidence/kali/6-config.png` |
